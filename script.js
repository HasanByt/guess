...
// Leaderboard Modal öffnen/schließen
...
// Save Modal schließen bei Klick auf Hintergrund
...
async function guessTheNumber() {
  ...
  if (guess === numberToGuess) {
    ...
    headline.textContent = "Die gesuchte Zahl ist größer!";
  } else {
...
function updateHeat(guess) {
  ...
  else if (diff <= 3) label = "Brennend heiß 🔥";
